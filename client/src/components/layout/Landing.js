  ...
  return (
    <Fragment>
      <section className='landing'>
        ...
        <div className='logo'>
          <img src='./logo512.png' alt='Mora UXPlore Logo' />
        ...
        <div>
          ...
          <div className='hidden top'>
            <ul>
              ...
              <li>
                All participating teams will be given a design challenge and
                have to submit their solutions within a specified timeframe.
              </li>
              <li>
